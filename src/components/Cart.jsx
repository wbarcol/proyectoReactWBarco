      ...
      <div className='flex shadow-md my-10'>
        <div className='w-3/4 bg-white px-10 py-10'>
          <div className='flex justify-between border-b pb-8'>
            ...
            <h2 className='font-semibold text-2xl'><Icon cant={cart.length} /></h2>
          </div>
            ...
            cart.map((item) => (
              <div className='flex items-center hover:bg-gray-100 -mx-8 px-6 py-5'>
                ...
                <div className='flex justify-center w-1/5'>
                  ...
                  <button
                      onClick={() => removeUni(item.id, item.cantidad, item.count)}
                      >
                  <svg 
                  ...
                  <button
                      onClick={() => addUni(item.id, item.cantidad, item.count)}
                      >
                  <svg
                    className='fill-current text-gray-600 w-3'
                    viewBox='0 0 448 512'
                ...
                <span className='text-center w-1/5 font-semibold text-sm'>
                  U$D {parseInt(item.precio) * parseInt(item.count)}
                </span>
              </div>
            ))}
          <Link
